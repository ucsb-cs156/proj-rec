...
public class RequestTypeControllerTests extends ControllerTestCase {
  ...
  @MockBean RequestTypeRepository requestTypeRepository;
  ...
  public void logged_out_users_cannot_get_all() throws Exception {
    mockMvc
        .perform(get("/api/requesttypes/all"))
  ...
  public void logged_in_users_can_get_all() throws Exception {
    mockMvc.perform(get("/api/requesttypes/all")).andExpect(status().is(200)); // logged
  }

  @Test
  public void logged_out_users_cannot_get_by_id() throws Exception {
    mockMvc
        .perform(get("/api/requesttypes?id=7"))
  ...
  public void logged_out_users_cannot_post() throws Exception {
    mockMvc.perform(post("/api/requesttypes/post")).andExpect(status().is(403));
  }
  ...
  public void logged_in_regular_users_cannot_post() throws Exception {
    mockMvc
        .perform(post("/api/requesttypes/post"))
  ...
  public void logged_out_users_cannot_put() throws Exception {
    mockMvc.perform(put("/api/requesttypes/put")).andExpect(status().is(403));
  }
  ...
  public void logged_in_regular_users_cannot_put() throws Exception {
    mockMvc
        .perform(put("/api/requesttypes/put"))
  ...
  public void logged_out_users_cannot_delete() throws Exception {
    mockMvc.perform(delete("/api/requesttypes/delete")).andExpect(status().is(403));
  }
  ...
  public void logged_in_regular_users_cannot_delete() throws Exception {
    mockMvc
        .perform(delete("/api/requesttypes/delete"))
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    // arrange
    RequestType requestType = RequestType.builder().requestType("Internship").build();

    when(requestTypeRepository.findById(eq(7L))).thenReturn(Optional.of(requestType));

    // act
    MvcResult response =
        mockMvc.perform(get("/api/requesttypes?id=7")).andExpect(status().isOk()).andReturn();
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_does_not_exist() throws Exception {
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/requesttypes?id=7")).andExpect(status().isNotFound()).andReturn();
  ...
  public void logged_in_user_can_get_all_requesttypes() throws Exception {
    ...
    // arrange
    RequestType requestType1 = RequestType.builder().requestType("Internship").build();

    RequestType requestType2 = RequestType.builder().requestType("Research Lab").build();
    ...
    // act
    MvcResult response =
        mockMvc.perform(get("/api/requesttypes/all")).andExpect(status().isOk()).andReturn();
  ...
  public void an_admin_user_can_post_a_new_requesttype() throws Exception {
    ...
    // arrange
    RequestType requestType1 = RequestType.builder().requestType("Research").build();
    ...
    MvcResult response =
        mockMvc
            .perform(post("/api/requesttypes/post?requestType=Research").with(csrf()))
  ...
  public void an_admin_user_cannot_post_a_duplicate_requesttype() throws Exception {
    ...
    RequestType requestType2 = RequestType.builder().requestType("Internship").build();
    ...
    MvcResult response =
        mockMvc
            .perform(post("/api/requesttypes/post?requestType=Internship").with(csrf()))
  ...
  public void an_admin_user_can_post_a_non_duplicate_requesttype() throws Exception {
    ...
    RequestType requestType2 = RequestType.builder().requestType("Research").build();
  ...
  public void admin_can_delete_a_requesttype() throws Exception {
    ...
    // arrange
    RequestType requestType1 = RequestType.builder().requestType("Fellowship").build();
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/requesttypes?id=15").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void admin_can_edit_an_existing_requesttype() throws Exception {
    ...
    // arrange
    RequestType requestTypeOrig = RequestType.builder().requestType("Pre School").build();

    RequestType requestTypeEdited = RequestType.builder().requestType("Grad School").build();
    ...
    verify(requestTypeRepository, times(1))
        .save(requestTypeEdited); // should be saved with correct user
    String responseString = response.getResponse().getContentAsString();
  ...
  public void admin_cannot_edit_a_duplicate_requesttype() throws Exception {
    ...
    RequestType requestTypeOrig = RequestType.builder().requestType("Grad School").build();

    RequestType requestTypeEdited = RequestType.builder().id(67).requestType("Internship").build();
    ...
    assertEquals("IllegalArgumentException", json.get("type"));
    assertEquals(
        "Duplicate request type: RequestType(id=67, requestType=Internship)", json.get("message"));
  }
  ...
  public void admin_can_edit_a_non_duplicate_requesttype() throws Exception {
    ...
    RequestType requestTypeOrig = RequestType.builder().id(67).requestType("Grad School").build();

    RequestType requestTypeEdited = RequestType.builder().id(67).requestType("Research").build();
  ...
  public void requesttype_can_duplicate_itself() throws Exception {
    ...
    // arrange
    RequestType requestTypeOrig = RequestType.builder().requestType("Internship").build();

    RequestType requestTypeEdited = RequestType.builder().requestType("Internship").build();
  ...
  public void an_admin_user_cannot_put_an_empty_requesttype() throws Exception {
    ...
    RequestType requestTypeEdited = RequestType.builder().id(67).requestType("").build();
  ...
  public void non_duplicates_do_not_throw_exception() throws Exception {
    ...
    // arrange
    RequestType requestType1 = RequestType.builder().requestType("PhD").build();

    RequestType requestType2 = RequestType.builder().requestType("Masters").build();
    ...
    String responseString = response.getResponse().getContentAsString();
    assertEquals(
        "[{\"id\":0,\"requestType\":\"PhD\"},{\"id\":0,\"requestType\":\"Masters\"}]",
        responseString);
  }
  ...
  public void admin_cannot_edit_requesttype_that_does_not_exist() throws Exception {
    ...
    // arrange
    RequestType requestTypeEdited = RequestType.builder().requestType("PhD").build();
