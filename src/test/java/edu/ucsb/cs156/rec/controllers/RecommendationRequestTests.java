...
public class RecommendationRequestTests extends ControllerTestCase {
  ...
  public void logged_out_users_cannot_get_all_requester() throws Exception {
    mockMvc
        .perform(get("/api/recommendationrequest/requester/all"))
  ...
  public void logged_out_users_cannot_get_all_professor() throws Exception {
    mockMvc
        .perform(get("/api/recommendationrequest/professor/all"))
        .andExpect(status().is(403)); // logged out users can't get all
  }
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists_and_they_are_requester()
      throws Exception {
    ...
    when(recommendationRequestRepository.findById(eq(7L)))
        .thenReturn(Optional.of(recommendationRequest)); // Check not sure why id is 7
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists_and_they_are_professor()
      throws Exception {
  ...
  @Test
  public void
      test_that_logged_in_user_cannot_get_by_id_when_the_id_exists_and_they_arent_professor_or_requester()
          throws Exception {
  ...
  public void logged_in_user_can_get_all_recommendation_requests_by_them() throws Exception {
    ...
    when(recommendationRequestRepository.findAllByRequesterId(currentUser.getId()))
        .thenReturn(expectedRecommendationRequests);
  ...
  public void logged_in_professors_can_get_all_recommendation_requests_for_them() throws Exception {
    ...
    when(recommendationRequestRepository.findAllByProfessorId(currentUser.getId()))
        .thenReturn(expectedRecommendationRequests);
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void a_user_can_post_a_new_recommendation_request_with_existing_professor()
      throws Exception {
    // arrange
  ...
  @WithMockUser(roles = {"USER"})
  @Test
  public void a_user_can_post_a_new_recommendation_request_without_existing_professor()
      throws Exception {
    // act
    ...
    mockMvc
        ...
        .andExpect(
            result ->
                assertEquals(
                    "User with id 7 not found", result.getResolvedException().getMessage()));
  }
  ...
  public void test_professor_can_get_recommendation_request_by_type() throws Exception {
    ...
    RecommendationRequest mockRequest1 =
        RecommendationRequest.builder()
            .id(101L)
            ...
            .details("Details 1")
            .build();
    RecommendationRequest mockRequest2 =
        RecommendationRequest.builder()
            .id(102L)
            .professor(mockProfessor)
            .status("completed")
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/recommendationrequest/professor/filtered").param("status", "completed"))
        .andExpect(status().isOk())
    ...
    verify(recommendationRequestRepository, times(1))
        .findAllByProfessorIdAndStatus(1L, "completed");
  }
  ...
  public void test_professor_get_recommendation_request_by_status_empty_list() throws Exception {
    ...
    when(userRepository.findByEmail("professor@ucsb.edu"))
        .thenReturn(java.util.Optional.of(mockProfessor));
    when(recommendationRequestRepository.findAllByProfessorIdAndStatus(1L, "completed"))
        .thenReturn(mockRequests);
  ...
  @Test
  @WithMockUser(roles = {"USER"})
  public void test_non_professor_get_recommendation_request_by_status_access_denied()
      throws Exception {
    // Act & Assert
    mockMvc
        .perform(get("/api/recommendationrequest/professor/filtered").param("status", "completed"))
    ...
    verify(recommendationRequestRepository, times(0))
        .findAllByProfessorIdAndStatus(anyLong(), anyString());
  }
}
