...
public class HomePageWebIT {
    ...
    public void home_page_shows_greeting() throws Exception {
        ...
        assertThat(page.getByText("This is a webapp that allows students to submit different types of requests to professors at the University of California, Santa Barbara."))
                .isVisible();
    }
