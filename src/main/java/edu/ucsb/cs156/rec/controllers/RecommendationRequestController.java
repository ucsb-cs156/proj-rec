...
public class RecommendationRequestController extends ApiController {
     ...
     * 
     * CHECK if requesterId = currentUser.getId()
     * 
    ...
    @PreAuthorize("hasRole('ROLE_USER') && #incoming.requesterId == authentication.principal.id")
    @PutMapping("")
    public RecommendationRequest updateRecommendationRequest(
		...
		if (incoming.getRequesterId() != recommendationRequest.getRequesterId()) {
			// throw entity not found to reveal less information to any malicious user
			throw new EntityNotFoundException(RecommendationRequest.class, id);
		}
