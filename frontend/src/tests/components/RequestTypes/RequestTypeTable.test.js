...
describe("RequestTypeTable tests", () => {
  ...
  test("renders empty table correctly", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <RequestTypeTable requestTypes={[]} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>,
    );
  ...
  test("Has the expected column headers, content and buttons for instructor user", () => {
    // arrange
  ...
  test("Edit button navigates to the edit page", async () => {
    ...
    await waitFor(() =>
      expect(mockedNavigate).toHaveBeenCalledWith("/requesttypes/edit/2"),
    );
  });
